...
describe('[Challenge] Puppet v2', function () {
    ...
    it('Exploit', async function () {
        ...
        console.log("BALANCES AFTER TOKEN SWAP")
        await logBalances(attacker.address, "Attacker")
        await logBalances(this.uniswapExchange.address, "UniSwapExchange")

        // Calculate deposit required as collateral for tokens;
        await LendingPool.calculateDepositOfWETHRequired(POOL_INITIAL_TOKEN_BALANCE);
        console.log("Required deposit as colaterral for all tokens is", ethers.utils.formatEther(deposit));
        ...
        console.log("BALANCES AFTER WETH DEPOSIT")
        await logBalances(attacker.address, "Attacker")
        ...
        console.log("BALANCES AFTER TOKEN LOAN")
        await logBalances(attacker.address, "Attacker")
